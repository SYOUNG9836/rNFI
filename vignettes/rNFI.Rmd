...
importance_genus <- iv_nfi(nfi_sejong, sp = "GENUS")

# Calculate tree diversity indices using basal area
diversity_tree_ba <- diversity_nfi(nfi_sejong, sp = "SP", table = "tree", basal = TRUE)

# Calculate biomass by administrative district
biomass_district <- biomass_nfi(nfi_sejong, plotgrp = "SGG")

# Calculate CWD biomass grouped by administrative district and decay class
cwd_grpby <- cwd_biomass_nfi(nfi_sejong, plotgrp = "SGG", treegrp = "DECAY")
