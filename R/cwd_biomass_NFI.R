...
#' 
#' @description
#' cwd_biomass_nfi() is a function that estimates volume, carbon storage and carbon dioxide storage of Coarse Woody Debris (CWD).
#' It can provide estimates for individual plots, the entire study area, or specific groups within the study area using parameters `byplot`, `plotgrp` and `treegrp`.
...
#' 
#' @description
#' cwd_biomass_tsvis() is a function that estimates volume, carbon storage and carbon dioxide storage of Coarse Woody Debris (CWD).
