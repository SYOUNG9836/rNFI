...
#' 
#' @description
#' biomass_nfi() is a function that estimates volume, aboveground biomass, biomass, carbon storage and carbon dioxide storage.
...
#' 
#' @description
#' biomass_tsvis() is a function that estimates volume, aboveground biomass, biomass, carbon storage and carbon dioxide storage.
